...
exports.Wattsonic = void 0;
const homey_1 = __importDefault(require("homey"));
class Wattsonic extends homey_1.default.Device {
    constructor() {
        super(...arguments);
        this.holdingRegisters = {
            ...
            "l1_current": [11010, 1, 'UINT16', "L1 Current", -1],
            "l2_current": [11012, 1, 'UINT16', "L2 Current", -1],
            "l3_current": [11014, 1, 'UINT16', "L3 Current", -1],
            "temperature": [11032, 1, 'UINT16', "Temperature", -1],
            ...
            // total solar
            "inputPower": [11028, 2, 'UINT32', "Input Power", 0],
            "gridFrequency": [11015, 1, 'UINT16', "Grid Frequency", -2],
            "pv1Voltage": [11038, 1, 'UINT16', "pv1 Voltage", -1],
            "pv2Voltage": [11040, 1, 'UINT16', "pv2 Voltage", -1],
            "pvEnergyTotal": [11028, 2, 'UINT32', "PV Input Total Power", -1],
            "pv1InputPower": [11062, 2, 'UINT32', "PV1 Input Power", 0],
            "pv2InputPower": [11064, 2, 'UINT32', "PV2 Input Power", 0],
            "pvTodayEnergy": [11018, 2, 'UINT32', "Total PV Generation on that day", -1],
            "pvTotalEnergy": [11020, 2, 'UINT32', "Total PV Generation from Installation", -1],
            "error": [10112, 2, 'UINT32', "Error", 0],
        };
        this.holdingRegistersBattery = {
            "SN": [10000, 8, 'STRING', "Inverter SN", 0],
            "firmware": [10011, 2, 'UINT32', "Firmware Version", 0],
            "equipment": [10008, 1, 'UINT16', "Equipment Info", 0],
            "l1_current": [11010, 1, 'UINT16', "L1 Current", -1],
            ...
            "pvTotalEnergy": [11020, 2, 'UINT32', "Total PV Generation from Installation", -1],
            "error": [10112, 2, 'UINT32', "Error", 0],
            "battvoltage": [30254, 1, 'UINT16', "battery Voltage", -1],
            ...
            "battsoc": [33000, 1, 'UINT16', "battery soc", -2],
            "batttemperature": [33003, 1, 'UINT16', "bms Temperature", -1],
            "bmshealth": [33001, 1, 'UINT16', "bms soh", -2],
            "bmsstatus": [33002, 1, 'UINT16', "bms status", 0],
            "bmserror": [33016, 2, 'UINT32', "bms error", 0],
            "today_grid_import": [31001, 1, 'UINT16', "Today's Grid Import", -1],
            "today_grid_export": [31000, 1, 'UINT16', "Today's Grid Export", -1],
            "total_grid_import": [31104, 2, 'UINT32', "Total Grid Import", -1],
            // Total Energy injected to grid
            "total_grid_export": [31102, 2, 'UINT32', "Total Grid Export", -1],
            "today_battery_output_energy": [31004, 1, 'UINT16', "Today's Battery Output Energy", -1],
            ...
            "total_battery_input_energy": [31108, 2, 'UINT32', "Total Battery Input Energy", -1],
            "today_load": [31006, 1, 'UINT16', "Today's Load", -1],
            "total_load": [31114, 2, 'UINT32', "Total Load", -1],
