...
class MyWattsonicDevice extends wattsonic_1.Wattsonic {
    /**
    ...
    async pollInvertor() {
        ...
        socket.on('connect', async () => {
            ...
            const checkRegisterRes = await (0, response_1.checkHoldingRegisterWattsonic)(this.holdingRegisters, client);
